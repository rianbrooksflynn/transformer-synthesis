set moduleName lin_projection_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_s
set isTopModule 0
...
set C_modelName {lin_projection<ap_fixed<16, 6, 5, 3, 0>, ap_fixed<33, 13, 5, 3, 0>, config3>}
...
set C_modelArgList {
	...
	{ k_proj_0 int 66 regular {fifo 1 volatile }  }
	{ q_proj_0 int 66 regular {fifo 1 volatile }  }
	{ v_proj_0 int 66 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "d_query_0_0", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "k_proj_0", "interface" : "fifo", "bitwidth" : 66, "direction" : "WRITEONLY"} , 
 	{ "Name" : "q_proj_0", "interface" : "fifo", "bitwidth" : 66, "direction" : "WRITEONLY"} , 
 	{ "Name" : "v_proj_0", "interface" : "fifo", "bitwidth" : 66, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ k_proj_0_din sc_out sc_lv 66 signal 8 } 
	{ k_proj_0_num_data_valid sc_in sc_lv 6 signal 8 } 
	{ k_proj_0_fifo_cap sc_in sc_lv 6 signal 8 } 
	{ k_proj_0_full_n sc_in sc_logic 1 signal 8 } 
	{ k_proj_0_write sc_out sc_logic 1 signal 8 } 
	{ q_proj_0_din sc_out sc_lv 66 signal 9 } 
	{ q_proj_0_num_data_valid sc_in sc_lv 6 signal 9 } 
	{ q_proj_0_fifo_cap sc_in sc_lv 6 signal 9 } 
	{ q_proj_0_full_n sc_in sc_logic 1 signal 9 } 
	{ q_proj_0_write sc_out sc_logic 1 signal 9 } 
	{ v_proj_0_din sc_out sc_lv 66 signal 10 } 
	{ v_proj_0_num_data_valid sc_in sc_lv 6 signal 10 } 
	{ v_proj_0_fifo_cap sc_in sc_lv 6 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "k_proj_0_din", "direction": "out", "datatype": "sc_lv", "bitwidth":66, "type": "signal", "bundle":{"name": "k_proj_0", "role": "din" }} , 
 	...
 	{ "name": "q_proj_0_din", "direction": "out", "datatype": "sc_lv", "bitwidth":66, "type": "signal", "bundle":{"name": "q_proj_0", "role": "din" }} , 
 	...
 	{ "name": "v_proj_0_din", "direction": "out", "datatype": "sc_lv", "bitwidth":66, "type": "signal", "bundle":{"name": "v_proj_0", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "13", "23"],
		"CDFG" : "lin_projection_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_s",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "d_query_0_0", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_query_0_1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_query_0_2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_query_0_3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_value_0_0", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_value_0_1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_value_0_2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_value_0_3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "k_proj_0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "20", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "k_proj_0_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "q_proj_0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "20", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "q_proj_0_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "v_proj_0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "20", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "v_proj_0_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "key_weight3", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_s_fu_97", "Port" : "key_weight3", "Inst_start_state" : "20", "Inst_end_state" : "22"}]},
			{"Name" : "query_weight3", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "13", "SubInstance" : "grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_1_fu_109", "Port" : "query_weight3", "Inst_start_state" : "20", "Inst_end_state" : "22"}]},
			{"Name" : "value_weight3", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "23", "SubInstance" : "grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_2_fu_121", "Port" : "value_weight3", "Inst_start_state" : "20", "Inst_end_state" : "22"}]}],
		"SubInstanceBlock" : [
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_read_stream_array_ap_fixed_16_6_5_3_0_4_s_fu_85", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "d_query_1_3", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "d_query_1_3_blk_n", "Type" : "RtlPort"}]}]},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_s_fu_97", "Parent" : "0", "Child" : ["4", "5", "6", "7", "8", "9", "10", "11", "12"],
		...
		"Port" : [
			...
			{"Name" : "key_weight3", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_s_fu_97.key_weight3_U", "Parent" : "3"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_s_fu_97.mul_16s_11s_26_1_1_U25", "Parent" : "3"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_s_fu_97.mul_16s_11s_26_1_1_U26", "Parent" : "3"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_s_fu_97.mul_16s_11s_26_1_1_U27", "Parent" : "3"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_s_fu_97.mul_16s_11s_26_1_1_U28", "Parent" : "3"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_s_fu_97.mul_16s_11s_26_1_1_U29", "Parent" : "3"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_s_fu_97.mul_16s_11s_26_1_1_U30", "Parent" : "3"},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_s_fu_97.mul_16s_11s_26_1_1_U31", "Parent" : "3"},
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_s_fu_97.mul_16s_11s_26_1_1_U32", "Parent" : "3"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_1_fu_109", "Parent" : "0", "Child" : ["14", "15", "16", "17", "18", "19", "20", "21", "22"],
		...
		"Port" : [
			...
			{"Name" : "idx2", "Type" : "None", "Direction" : "I"},
			{"Name" : "query_weight3", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "14", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_1_fu_109.query_weight3_U", "Parent" : "13"},
	{"ID" : "15", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_1_fu_109.mul_16s_11s_26_1_1_U40", "Parent" : "13"},
	{"ID" : "16", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_1_fu_109.mul_16s_11s_26_1_1_U41", "Parent" : "13"},
	{"ID" : "17", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_1_fu_109.mul_16s_11s_26_1_1_U42", "Parent" : "13"},
	{"ID" : "18", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_1_fu_109.mul_16s_11s_26_1_1_U43", "Parent" : "13"},
	{"ID" : "19", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_1_fu_109.mul_16s_11s_26_1_1_U44", "Parent" : "13"},
	{"ID" : "20", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_1_fu_109.mul_16s_11s_26_1_1_U45", "Parent" : "13"},
	{"ID" : "21", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_1_fu_109.mul_16s_11s_26_1_1_U46", "Parent" : "13"},
	{"ID" : "22", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_1_fu_109.mul_16s_11s_26_1_1_U47", "Parent" : "13"},
	{"ID" : "23", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_2_fu_121", "Parent" : "0", "Child" : ["24", "25", "26", "27", "28", "29", "30", "31", "32"],
		"CDFG" : "dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_2",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "Aligned", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "1",
		...
		"Port" : [
			...
			{"Name" : "idx2", "Type" : "None", "Direction" : "I"},
			{"Name" : "value_weight3", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "24", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_2_fu_121.value_weight3_U", "Parent" : "23"},
	{"ID" : "25", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_2_fu_121.mul_16s_11s_26_1_1_U54", "Parent" : "23"},
	{"ID" : "26", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_2_fu_121.mul_16s_11s_26_1_1_U55", "Parent" : "23"},
	{"ID" : "27", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_2_fu_121.mul_16s_11s_26_1_1_U56", "Parent" : "23"},
	{"ID" : "28", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_2_fu_121.mul_16s_11s_26_1_1_U57", "Parent" : "23"},
	{"ID" : "29", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_2_fu_121.mul_16s_11s_26_1_1_U58", "Parent" : "23"},
	{"ID" : "30", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_2_fu_121.mul_16s_11s_26_1_1_U59", "Parent" : "23"},
	{"ID" : "31", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_2_fu_121.mul_16s_11s_26_1_1_U60", "Parent" : "23"},
	{"ID" : "32", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dense_latency_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_1_2_fu_121.mul_16s_11s_26_1_1_U61", "Parent" : "23"}]}
...
set ArgLastReadFirstWriteLatency {
	lin_projection_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_s {
		...
		k_proj_0 {Type O LastRead -1 FirstWrite 3}
		q_proj_0 {Type O LastRead -1 FirstWrite 3}
		v_proj_0 {Type O LastRead -1 FirstWrite 3}
...
set Spec2ImplPortList { 
	...
	k_proj_0 { ap_fifo {  { k_proj_0_din fifo_data_in 1 66 }  { k_proj_0_num_data_valid fifo_status_num_data_valid 0 6 }  { k_proj_0_fifo_cap fifo_update 0 6 }  { k_proj_0_full_n fifo_status 0 1 }  { k_proj_0_write fifo_port_we 1 1 } } }
	q_proj_0 { ap_fifo {  { q_proj_0_din fifo_data_in 1 66 }  { q_proj_0_num_data_valid fifo_status_num_data_valid 0 6 }  { q_proj_0_fifo_cap fifo_update 0 6 }  { q_proj_0_full_n fifo_status 0 1 }  { q_proj_0_write fifo_port_we 1 1 } } }
	v_proj_0 { ap_fifo {  { v_proj_0_din fifo_data_in 1 66 }  { v_proj_0_num_data_valid fifo_status_num_data_valid 0 6 }  { v_proj_0_fifo_cap fifo_update 0 6 }  { v_proj_0_full_n fifo_status 0 1 }  { v_proj_0_write fifo_port_we 1 1 } } }
}
