...
#define AUTOTB_TVOUT_layer_normalization_input "../tv/cdatafile/c.myproject.autotvout_layer_normalization_input.dat"
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_layer_normalization_input),
#endif
  };
  port0.param = __xlx_apatb_param_layer_normalization_input;
