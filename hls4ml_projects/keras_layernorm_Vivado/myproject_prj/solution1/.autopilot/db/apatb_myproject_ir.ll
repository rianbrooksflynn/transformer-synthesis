; ModuleID = '/data/hlssynt-users/rflynn/transformer-synthesis/hls4ml_projects/keras_layernorm_Vivado/myproject_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_myproject_ir(%"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="100" %layer_normalization_input, %"struct.ap_fixed<33, 13, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="100" "partition" %layer2_out) local_unnamed_addr #0 {
entry:
  %layer_normalization_input_copy3 = alloca i1600, align 512
...
for.loop:                                         ; preds = %dst.addr.0.0.06.exit, %for.loop.lr.ph
  ...
  %src.addr.0.0.05 = getelementptr [100 x %"struct.ap_fixed<33, 13, AP_TRN, AP_WRAP, 0>"], [100 x %"struct.ap_fixed<33, 13, AP_TRN, AP_WRAP, 0>"]* %src, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
...
for.loop:                                         ; preds = %src.addr.0.0.05.exit, %for.loop.lr.ph
  ...
  %1 = trunc i64 %for.loop.idx2 to i7
  %dst.addr.0.0.06 = getelementptr [100 x %"struct.ap_fixed<33, 13, AP_TRN, AP_WRAP, 0>"], [100 x %"struct.ap_fixed<33, 13, AP_TRN, AP_WRAP, 0>"]* %dst, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
...
src.addr.0.0.05.case.99:                          ; preds = %for.loop
  ...
  %300 = bitcast i33* %src_99 to i40*
  %301 = load i40, i40* %300
  %302 = trunc i40 %301 to i33
  br label %src.addr.0.0.05.exit
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a100struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.35"(i1600* nocapture "orig.arg.no"="0" "unpacked"="0.0" %dst, i64 %dst_shift, [100 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* readonly "orig.arg.no"="1" "unpacked"="1" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #2 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %4 = load i1600, i1600* %dst, align 256
  %5 = zext i64 %2 to i1600
  %6 = shl i1600 65535, %5
  %7 = zext i16 %3 to i1600
  %8 = shl i1600 %7, %5
  %thr.xor1 = xor i1600 %6, -1
  %thr.and2 = and i1600 %4, %thr.xor1
  %thr.or3 = or i1600 %thr.and2, %8
  store i1600 %thr.or3, i1600* %dst, align 256
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a100struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.32"(i1600* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst, [100 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias readonly "orig.arg.no"="1" "unpacked"="1" %src) #3 {
entry:
  %0 = icmp eq [100 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a100struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.35"(i1600* %dst, i64 0, [100 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 100)
  br label %ret
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %3 = load i1600, i1600* %src, align 256
  %4 = zext i64 %2 to i1600
  %5 = lshr i1600 %3, %4
  %6 = trunc i1600 %5 to i16
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a100struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"([100 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, i1600* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src) #3 {
entry:
  %0 = icmp eq [100 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a100struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"([100 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, i1600* %src, i64 0, i64 100)
  br label %ret
