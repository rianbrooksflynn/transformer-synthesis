...
module myproject_data_prep_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
always @ (*) begin
    if (((1'b0 == ap_block_state20) & (1'b1 == ap_CS_fsm_state20))) begin
        ...
        d_query_0_0_din = trunc_ln250_fu_376_p1;
    end else begin
        d_query_0_0_din = 'bx;
    end
end
...
endmodule //myproject_data_prep_ap_fixed_16_6_5_3_0_ap_fixed_33_13_5_3_0_config3_s
