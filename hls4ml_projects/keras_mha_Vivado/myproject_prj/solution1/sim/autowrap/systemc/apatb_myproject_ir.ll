; ModuleID = '/home/rian/A3D3/transformer-synthesis/hls4ml_projects/keras_mha_Vivado/myproject_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a80struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.107"(i1280* nocapture "orig.arg.no"="0" "unpacked"="0.0" %dst, i64 %dst_shift, [80 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* readonly "orig.arg.no"="1" "unpacked"="1" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
  %0 = icmp eq [80 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a80struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.107"(i1280* %dst, i64 0, [80 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 80)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a80struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.114"([80 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* "orig.arg.no"="0" "unpacked"="0" %dst, i1280* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0" %src, i64 %src_shift, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a80struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.111"([80 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, i1280* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src) #3 {
entry:
  %0 = icmp eq [80 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a80struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.114"([80 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, i1280* %src, i64 0, i64 80)
  br label %ret
...
entry:
  call void @"onebyonecpy_hls.p0a80struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.111"([80 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %0, i1280* align 512 %1)
  call void @"onebyonecpy_hls.p0a80struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>.111"([80 x %"struct.ap_fixed<16, 6, AP_TRN, AP_WRAP, 0>"]* %2, i1280* align 512 %3)
  call void @"onebyonecpy_hls.p0a80struct.ap_fixed<33, 13, AP_TRN, AP_WRAP, 0>.94"([80 x %"struct.ap_fixed<33, 13, AP_TRN, AP_WRAP, 0>"]* %4, i33* align 512 %_0, i33* align 512 %_1, i33* align 512 %_2, i33* align 512 %_3, i33* align 512 %_4, i33* align 512 %_5, i33* align 512 %_6, i33* align 512 %_7, i33* align 512 %_8, i33* align 512 %_9, i33* align 512 %_10, i33* align 512 %_11, i33* align 512 %_12, i33* align 512 %_13, i33* align 512 %_14, i33* align 512 %_15, i33* align 512 %_16, i33* align 512 %_17, i33* align 512 %_18, i33* align 512 %_19, i33* align 512 %_20, i33* align 512 %_21, i33* align 512 %_22, i33* align 512 %_23, i33* align 512 %_24, i33* align 512 %_25, i33* align 512 %_26, i33* align 512 %_27, i33* align 512 %_28, i33* align 512 %_29, i33* align 512 %_30, i33* align 512 %_31, i33* align 512 %_32, i33* align 512 %_33, i33* align 512 %_34, i33* align 512 %_35, i33* align 512 %_36, i33* align 512 %_37, i33* align 512 %_38, i33* align 512 %_39, i33* align 512 %_40, i33* align 512 %_41, i33* align 512 %_42, i33* align 512 %_43, i33* align 512 %_44, i33* align 512 %_45, i33* align 512 %_46, i33* align 512 %_47, i33* align 512 %_48, i33* align 512 %_49, i33* align 512 %_50, i33* align 512 %_51, i33* align 512 %_52, i33* align 512 %_53, i33* align 512 %_54, i33* align 512 %_55, i33* align 512 %_56, i33* align 512 %_57, i33* align 512 %_58, i33* align 512 %_59, i33* align 512 %_60, i33* align 512 %_61, i33* align 512 %_62, i33* align 512 %_63, i33* align 512 %_64, i33* align 512 %_65, i33* align 512 %_66, i33* align 512 %_67, i33* align 512 %_68, i33* align 512 %_69, i33* align 512 %_70, i33* align 512 %_71, i33* align 512 %_72, i33* align 512 %_73, i33* align 512 %_74, i33* align 512 %_75, i33* align 512 %_76, i33* align 512 %_77, i33* align 512 %_78, i33* align 512 %_79)
  ret void
}
