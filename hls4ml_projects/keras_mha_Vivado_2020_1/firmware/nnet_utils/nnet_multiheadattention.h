...
void multiheadattention(
    ...
    #pragma HLS stream variable=d_value depth=CONFIG_T::feature_dim
    #pragma HLS stream variable=d_query depth=CONFIG_T::feature_dim
    #pragma HLS stream variable=q_proj depth=CONFIG_T::seq_len
    #pragma HLS stream variable=k_proj depth=CONFIG_T::seq_len
    #pragma HLS stream variable=v_proj depth=CONFIG_T::seq_len
    #pragma HLS stream variable=matr_out depth=CONFIG_T::head_dim_value
