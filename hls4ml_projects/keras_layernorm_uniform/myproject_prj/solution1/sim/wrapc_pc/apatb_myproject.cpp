...
// tvout file define:
#define AUTOTB_TVOUT_PC_layer_normalization_input "../tv/rtldatafile/rtl.myproject.autotvout_layer_normalization_input.dat"
// tvout file define:
...
INTER_TCL_FILE(const char* name) {
  mName = name; 
  layer_normalization_input_depth = 0;
  layer2_out_depth = 0;
  trans_num =0;
}
~INTER_TCL_FILE() {
...
string get_depth_list () {
  ...
  total_list << "{layer_normalization_input " << layer_normalization_input_depth << "}\n";
...
void set_num (int num , int* class_num) {
  ...
  public:
    int layer_normalization_input_depth;
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<64> > layer2_out_pc_buffer(20);
          int i = 0;
          ...
          if (i > 0) {{
            ...
            ((long long*)__xlx_apatb_param_layer2_out)[j] = layer2_out_pc_buffer[i].to_int64();
          }}}
        } // end transaction
      } // end file is good
...
aesl_fh.touch(AUTOTB_TVIN_layer_normalization_input);
aesl_fh.touch(AUTOTB_TVOUT_layer_normalization_input);
//layer2_out
aesl_fh.touch(AUTOTB_TVIN_layer2_out);
aesl_fh.touch(AUTOTB_TVOUT_layer2_out);
CodeState = DUMP_INPUTS;
// print layer_normalization_input Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_layer_normalization_input, __xlx_sprintf_buffer.data());
  {  if (__xlx_apatb_param_layer_normalization_input) {
    for (int j = 0, e = 20; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_layer_normalization_input)[j];
  ...
  tcl_file.set_num(20, &tcl_file.layer_normalization_input_depth);
...
// print layer2_out Transactions
{
  ...
  {  if (__xlx_apatb_param_layer2_out) {
    for (int j = 0, e = 20; j != e; ++j) {
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_layer2_out)[j];
...
myproject_hw_stub(__xlx_apatb_param_layer_normalization_input, __xlx_apatb_param_layer2_out);
