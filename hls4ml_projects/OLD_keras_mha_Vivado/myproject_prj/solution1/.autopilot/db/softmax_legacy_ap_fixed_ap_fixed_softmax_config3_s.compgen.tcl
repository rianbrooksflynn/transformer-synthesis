...
set name myproject_mul_24s_21ns_38_3_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_softmax_legacy_ap_fixed_ap_fixed_softmax_config3_s_exp_taeOg BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler myproject_softmax_legacy_ap_fixed_ap_fixed_softmax_config3_s_invertfYi BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
