set moduleName lin_projection_ap_fixed_ap_fixed_16_6_5_3_0_config3_s
set isTopModule 0
...
set C_modelName {lin_projection<ap_fixed,ap_fixed<16,6,5,3,0>,config3>}
...
set C_modelArgList {
	...
	{ k_proj_1 int 32 regular {fifo 1 volatile }  }
	{ q_proj_1 int 32 regular {fifo 1 volatile }  }
	{ v_proj_1 int 32 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "d_query_1_0", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "k_proj_1", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "q_proj_1", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "v_proj_1", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ k_proj_1_din sc_out sc_lv 32 signal 8 } 
	{ k_proj_1_num_data_valid sc_in sc_lv 3 signal 8 } 
	{ k_proj_1_fifo_cap sc_in sc_lv 3 signal 8 } 
	{ k_proj_1_full_n sc_in sc_logic 1 signal 8 } 
	{ k_proj_1_write sc_out sc_logic 1 signal 8 } 
	{ q_proj_1_din sc_out sc_lv 32 signal 9 } 
	{ q_proj_1_num_data_valid sc_in sc_lv 3 signal 9 } 
	{ q_proj_1_fifo_cap sc_in sc_lv 3 signal 9 } 
	{ q_proj_1_full_n sc_in sc_logic 1 signal 9 } 
	{ q_proj_1_write sc_out sc_logic 1 signal 9 } 
	{ v_proj_1_din sc_out sc_lv 32 signal 10 } 
	{ v_proj_1_num_data_valid sc_in sc_lv 3 signal 10 } 
	{ v_proj_1_fifo_cap sc_in sc_lv 3 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "k_proj_1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "k_proj_1", "role": "din" }} , 
 	...
 	{ "name": "q_proj_1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "q_proj_1", "role": "din" }} , 
 	...
 	{ "name": "v_proj_1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v_proj_1", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "13", "23"],
		"CDFG" : "lin_projection_ap_fixed_ap_fixed_16_6_5_3_0_config3_s",
		"Protocol" : "ap_ctrl_hs",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "d_query_1_0", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_query_1_1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_query_1_2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_query_1_3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_value_1_0", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_value_1_1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_value_1_2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "d_value_1_3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "k_proj_1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "k_proj_1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "q_proj_1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "q_proj_1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "v_proj_1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set ArgLastReadFirstWriteLatency {
	lin_projection_ap_fixed_ap_fixed_16_6_5_3_0_config3_s {
		...
		k_proj_1 {Type O LastRead -1 FirstWrite 4}
		q_proj_1 {Type O LastRead -1 FirstWrite 4}
		v_proj_1 {Type O LastRead -1 FirstWrite 4}
...
set Spec2ImplPortList { 
	...
	k_proj_1 { ap_fifo {  { k_proj_1_din fifo_data_in 1 32 }  { k_proj_1_num_data_valid fifo_status_num_data_valid 0 3 }  { k_proj_1_fifo_cap fifo_update 0 3 }  { k_proj_1_full_n fifo_status 0 1 }  { k_proj_1_write fifo_port_we 1 1 } } }
	q_proj_1 { ap_fifo {  { q_proj_1_din fifo_data_in 1 32 }  { q_proj_1_num_data_valid fifo_status_num_data_valid 0 3 }  { q_proj_1_fifo_cap fifo_update 0 3 }  { q_proj_1_full_n fifo_status 0 1 }  { q_proj_1_write fifo_port_we 1 1 } } }
	v_proj_1 { ap_fifo {  { v_proj_1_din fifo_data_in 1 32 }  { v_proj_1_num_data_valid fifo_status_num_data_valid 0 3 }  { v_proj_1_fifo_cap fifo_update 0 3 }  { v_proj_1_full_n fifo_status 0 1 }  { v_proj_1_write fifo_port_we 1 1 } } }
}
