...
// ==============================================================
`timescale 1 ns / 1 ps
module myproject_softmax_legacy_ap_fixed_ap_fixed_softmax_config3_s_exp_taeOg (
    address0, ce0, q0, 
    address1, ce1, q1, 
    address2, ce2, q2, 
    address3, ce3, q3, 
...
initial begin
    ...
    $readmemh("./myproject_softmax_legacy_ap_fixed_ap_fixed_softmax_config3_s_exp_taeOg.dat", rom0); 
    $readmemh("./myproject_softmax_legacy_ap_fixed_ap_fixed_softmax_config3_s_exp_taeOg.dat", rom1); 
    $readmemh("./myproject_softmax_legacy_ap_fixed_ap_fixed_softmax_config3_s_exp_taeOg.dat", rom2); 
    $readmemh("./myproject_softmax_legacy_ap_fixed_ap_fixed_softmax_config3_s_exp_taeOg.dat", rom3); 
    $readmemh("./myproject_softmax_legacy_ap_fixed_ap_fixed_softmax_config3_s_exp_taeOg.dat", rom4); 
    $readmemh("./myproject_softmax_legacy_ap_fixed_ap_fixed_softmax_config3_s_exp_taeOg.dat", rom5); 
    $readmemh("./myproject_softmax_legacy_ap_fixed_ap_fixed_softmax_config3_s_exp_taeOg.dat", rom6); 
    $readmemh("./myproject_softmax_legacy_ap_fixed_ap_fixed_softmax_config3_s_exp_taeOg.dat", rom7); 
    $readmemh("./myproject_softmax_legacy_ap_fixed_ap_fixed_softmax_config3_s_exp_taeOg.dat", rom8); 
    $readmemh("./myproject_softmax_legacy_ap_fixed_ap_fixed_softmax_config3_s_exp_taeOg.dat", rom9);
end
