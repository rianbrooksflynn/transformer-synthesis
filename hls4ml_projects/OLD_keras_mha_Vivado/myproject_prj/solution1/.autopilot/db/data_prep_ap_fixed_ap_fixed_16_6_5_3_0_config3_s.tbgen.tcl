set moduleName data_prep_ap_fixed_ap_fixed_16_6_5_3_0_config3_s
set isTopModule 0
...
set C_modelName {data_prep<ap_fixed,ap_fixed<16,6,5,3,0>,config3>}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		"CDFG" : "data_prep_ap_fixed_ap_fixed_16_6_5_3_0_config3_s",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "d_value_1_0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "d_value_1_0_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "d_value_1_1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "d_value_1_1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "d_value_1_2", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "d_value_1_2_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "d_value_1_3", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
