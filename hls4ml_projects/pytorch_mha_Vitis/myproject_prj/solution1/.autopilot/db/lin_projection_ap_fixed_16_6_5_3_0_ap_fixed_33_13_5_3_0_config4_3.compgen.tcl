...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { k_proj_1_din { O 66 vector } k_proj_1_num_data_valid { I 6 vector } k_proj_1_fifo_cap { I 6 vector } k_proj_1_full_n { I 1 bit } k_proj_1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { q_proj_1_din { O 66 vector } q_proj_1_num_data_valid { I 6 vector } q_proj_1_fifo_cap { I 6 vector } q_proj_1_full_n { I 1 bit } q_proj_1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { v_proj_1_din { O 66 vector } v_proj_1_num_data_valid { I 6 vector } v_proj_1_fifo_cap { I 6 vector } v_proj_1_full_n { I 1 bit } v_proj_1_write { O 1 bit } } \
} "
}
